...
function mapOpenWeatherIcon(code, isNight) {
...
function getIconPath(code, provider, isNight, iconPack) {
    var iconFile = getWeatherIcon(code, provider, isNight)
