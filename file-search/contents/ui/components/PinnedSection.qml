...
Item {
    ...
    ColumnLayout {
                ...
                Repeater {
                    ...
                    delegate: Rectangle {
                        ...
                        color: itemMouse.containsMouse 
                            ...
                            : Qt.rgba(pinnedSectionRoot.accentColor.r, pinnedSectionRoot.accentColor.g, pinnedSectionRoot.accentColor.b, 0.05)
                        radius: 4
        ...
        Rectangle {
            ...
            color: Qt.rgba(pinnedSectionRoot.textColor.r, pinnedSectionRoot.textColor.g, pinnedSectionRoot.textColor.b, 0.1)
            visible: pinnedSectionRoot.pinnedItems.length > 0
        }
    }
}
